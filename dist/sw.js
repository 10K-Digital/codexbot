...
const CACHE='equipe-shell-v17';
const SHELL=['/feedback.js','/live-voice.js','/voice.js','/mascot.svg','/','/app.js','/cards.mjs','/connection.mjs','/pwa.js','/i18n.mjs','/translations.mjs','/style.css','/manifest.webmanifest','/manifest.pt.webmanifest','/manifest.en.webmanifest','/manifest.es.webmanifest','/icon-192.png','/icon-512.png'];
